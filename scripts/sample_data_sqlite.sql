-- Sample data for SQLite SQLTrace testing
...
('john_doe', 'john.doe@example.com', 'John', 'Doe', 28, 'Engineering', 75000.00, 1),
('jane_smith', 'jane.smith@example.com', 'Jane', 'Smith', 32, 'Marketing', 65000.00, 1),
('bob_wilson', 'bob.wilson@example.com', 'Bob', 'Wilson', 45, 'Engineering', 95000.00, 1),
('alice_brown', 'alice.brown@example.com', 'Alice', 'Brown', 29, 'Sales', 55000.00, 1),
('charlie_davis', 'charlie.davis@example.com', 'Charlie', 'Davis', 35, 'Engineering', 85000.00, 1),
('diana_miller', 'diana.miller@example.com', 'Diana', 'Miller', 27, 'Marketing', 60000.00, 1),
('eve_garcia', 'eve.garcia@example.com', 'Eve', 'Garcia', 31, 'Sales', 58000.00, 1),
('frank_martinez', 'frank.martinez@example.com', 'Frank', 'Martinez', 42, 'Engineering', 92000.00, 1),
('grace_anderson', 'grace.anderson@example.com', 'Grace', 'Anderson', 26, 'Marketing', 62000.00, 1),
('henry_taylor', 'henry.taylor@example.com', 'Henry', 'Taylor', 38, 'Sales', 68000.00, 1),
('inactive_user', 'inactive@example.com', 'Inactive', 'User', 30, 'Support', 45000.00, 0);
...
(1, 75.98, 'delivered', datetime('now', '-30 days')),
(2, 299.97, 'delivered', datetime('now', '-15 days')),
(3, 149.99, 'delivered', datetime('now', '-60 days')),
(4, 89.97, 'delivered', datetime('now', '-45 days')),
(5, 199.98, 'delivered', datetime('now', '-7 days'));
